...
public class CtlCambioPagoTouch implements ActionListener,ItemListener, WindowListener ,KeyListener {
	private ViewCambioPagoTouch view=null;
	...
	public CtlCambioPagoTouch(ViewCambioPagoTouch v,BigDecimal t){
		total=t;
		view=v;
